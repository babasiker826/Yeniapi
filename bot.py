...
# TÜM API VERİLERİ - 62 API (URL'ler api2-nabi domainine göre düzeltildi)
ALL_APIS = [
    # Checker API'leri (8)
    ...
    # TC Sorgulama API'leri (6) - API2-NABI DOMAIN
    ...
    # Ad Soyad Sorgulama (4) - API2-NABI DOMAIN
    ...
    # İş ve Vergi Sorgulama (3) - API2-NABI DOMAIN
    ...
    # TC-GSM Sorgulama (2) - API2-NABI DOMAIN
    ...
    # Adres ve Konum Sorgulama (4) - API2-NABI DOMAIN
    ...
    # Network Sorgulama (4) - API2-NABI DOMAIN
    ...
    # Leak ve Telegram (2) - API2-NABI DOMAIN
    ...
    # IBAN API'leri (2) - API2-NABI DOMAIN
    ...
    # Şifre Encrypt (1) - API2-NABI DOMAIN
    ...
    # Ödeme API'leri (1) - API2-NABI DOMAIN
