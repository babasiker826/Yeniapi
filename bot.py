...
# TÜM API VERİLERİ - 62 API (Endpoint'ler düzeltildi)
ALL_APIS = [
    # Checker API'leri (8)
    ...
    # TC Sorgulama API'leri (6) - DÜZELTİLDİ
    {"id": "tc", "title": "TC SORGULAMA", "icon": "🆔", "url": "https://api-nabi.trr.gt.tc/tc?tc=12345678901", "desc": "TC kimlik no sorgulama."},
    {"id": "tc_pro", "title": "TC PRO SORGULAMA", "icon": "🔍", "url": "https://api-nabi.trr.gt.tc/tcpro?tc=12345678901", "desc": "Detaylı TC sorgulama."},
    {"id": "aile", "title": "AILE SORGULAMA", "icon": "👨‍👩‍👧‍👦", "url": "https://api-nabi.trr.gt.tc/aile?tc=12345678901", "desc": "Aile bireylerini sorgulama."},
    {"id": "aile_pro", "title": "AILE PRO SORGULAMA", "icon": "🏠", "url": "https://api-nabi.trr.gt.tc/ailepro?tc=12345678901", "desc": "Detaylı aile sorgulama."},
    {"id": "sulale", "title": "SÜLALE SORGULAMA", "icon": "🌳", "url": "https://api-nabi.trr.gt.tc/sulale?tc=12345678901", "desc": "Sülale/soy ağacı sorgulama."},
    {"id": "hayat_hikayesi", "title": "HAYAT HİKAYESİ", "icon": "📖", "url": "https://api-nabi.trr.gt.tc/hayathikayesi?tc=12345678901", "desc": "Kişisel hayat hikayesi."},
    
    # Ad Soyad Sorgulama (4) - DÜZELTİLDİ
    ...
    {"id": "ad_soyad", "title": "AD SOYAD SORGULAMA 2", "icon": "🔎", "url": "https://api-nabi.trr.gt.tc/adsoyad?ad=Mehmet&soyad=Demir", "desc": "Alternatif ad soyad sorgu."},
    {"id": "ad_soyad_pro", "title": "AD SOYAD PRO", "icon": "💼", "url": "https://api-nabi.trr.gt.tc/adsoyadpro?ad=Ahmet&soyad=Kaya", "desc": "Profesyonel ad soyad sorgu."},
    {"id": "adi_il_ilce", "title": "AD İL İLÇE SORGULAMA", "icon": "📍", "url": "https://api-nabi.trr.gt.tc/adiililce?ad=Ayşe&il=İstanbul&ilce=Kadıköy", "desc": "Ad, il ve ilçe ile sorgu."},
    
    # İş ve Vergi Sorgulama (3) - DÜZELTİLDİ
    {"id": "is_yeri", "title": "İŞ YERİ SORGULAMA", "icon": "🏢", "url": "https://api-nabi.trr.gt.tc/isyeri?vergino=1234567890", "desc": "Vergi no ile iş yeri sorgu."},
    {"id": "vergi_no", "title": "VERGİ NO SORGULAMA", "icon": "💰", "url": "https://api-nabi.trr.gt.tc/vergino?vergino=1234567890", "desc": "Vergi numarası sorgulama."},
    {"id": "yas", "title": "YAŞ SORGULAMA", "icon": "🎂", "url": "https://api-nabi.trr.gt.tc/yas?yas=25", "desc": "Yaş bazlı sorgulama."},
    
    # TC-GSM Sorgulama (2) - DÜZELTİLDİ
    {"id": "tc_gsm", "title": "TC GSM SORGULAMA", "icon": "📱", "url": "https://api-nabi.trr.gt.tc/tcgsm?tc=12345678901", "desc": "TC den GSM sorgulama."},
    {"id": "gsm_tc", "title": "GSM TC SORGULAMA", "icon": "📞", "url": "https://api-nabi.trr.gt.tc/gsmtc?gsm=5551234567", "desc": "GSM den TC sorgulama."},
    
    # Adres ve Konum Sorgulama (4) - DÜZELTİLDİ
    ...
    {"id": "ada_parsel", "title": "ADA PARSEL SORGULAMA", "icon": "🗺️", "url": "https://api-nabi.trr.gt.tc/adaparsel?ada=1&parsel=25", "desc": "Ada ve parsel sorgulama."},
    
    # Eş ve Aile Sorgulama (1) - DÜZELTİLDİ
    {"id": "es", "title": "EŞ SORGULAMA", "icon": "💑", "url": "https://api-nabi.trr.gt.tc/es?tc=12345678901", "desc": "Eş bilgisi sorgulama."},
    
    # Eğitim Sorgulama (2) - DÜZELTİLDİ
    {"id": "lgs", "title": "LGS SORGULAMA", "icon": "🎓", "url": "https://api-nabi.trr.gt.tc/lgs?tc=12345678901", "desc": "LGS sonuçları sorgulama."},
    {"id": "e_kurs", "title": "E-KURS SORGULAMA", "icon": "📚", "url": "https://api-nabi.trr.gt.tc/ekurs?tc=12345678901", "desc": "E-kurs bilgileri sorgu."},
    
    # Network Sorgulama (4) - DÜZELTİLDİ
    ...
    # IBAN API'leri (2) - DÜZELTİLDİ
    {"id": "iban_verify", "title": "IBAN DOĞRULAMA", "icon": "✅", "url": "https://api-nabi.trr.gt.tc/ibanverify?iban=TR330006100519786457841326", "desc": "IBAN doğrulama endpointi."},
    {"id": "iban_query", "title": "IBAN SORGULAMA", "icon": "🔎", "url": "https://api-nabi.trr.gt.tc/ibanquery?iban=TR330006100519786457841326", "desc": "IBAN ile banka bilgisi."},
    
    # Şifre Encrypt (1) - DÜZELTİLDİ
    {"id": "sifre_encrypt", "title": "ŞİFRE ENCRYPT", "icon": "🔒", "url": "https://api-nabi.trr.gt.tc/sifreencrypt?sifre=myPassword123", "desc": "Şifre encrypt işlemi."},
    
    # Ödeme API'leri (1) - DÜZELTİLDİ
...
# HTML template (geri kalan kod aynı)
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="tr">
<head>
